...
class SubscriptionService extends BaseModelService
{
    ...
    public function __construct(SubscriptionPlanService $subscriptionPlanService, SubscriptionHistoryService $subscriptionHistoryService, HRMService $hrmService)
    {
    ...
    public function syncSubscription($company, $subscription)
    {
        ...
        $this->hrmService->syncSubscription($data, $company);
    }

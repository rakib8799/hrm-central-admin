...
class UpdateSubscriptionPlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'max_active_users' => 'nullable|integer|min:1'
        ];
    }
    ...
    function messages()
    {
        return [
            ...
            'max_active_users.integer' => 'Max active users must be an integer',
            'max_active_users.min' => 'Max active users must be at least 1'
        ];
    }
}

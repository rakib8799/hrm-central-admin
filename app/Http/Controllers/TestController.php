...
{
    protected EmailEventService $emailEventService;
    protected SubscriptionPlanService $subscriptionPlanService;

    public function __construct(EmailEventService $emailEventService, SubscriptionPlanService $subscriptionPlanService)
    {
    ...
    public function createEmailEvent()
    {
        ...
        $this->emailEventService->createEmailEvent($data);

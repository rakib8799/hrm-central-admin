...
use App\Http\Requests\Configuration\UpdateGlobalInfoRequest;
...
class ConfigurationController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            new Middleware('permission:can-edit-configuration', only: ['basicInfo', 'updateBasicInfo', 'additionalInfo', 'updateAdditionalInfo', 'contactInfo', 'updateContactInfo']),
        ];
    }
    ...
    public function updateGlobalInfo(UpdateGlobalInfoRequest $request)
    {
        $validatedData = $request->validated();
        $isUpdated = $this->configurationService->updateConfiguration($validatedData);
        if ($isUpdated) {

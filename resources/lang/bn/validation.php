    ...
    */
    ...
    'custom' => [
        ...
        'configuration' => [
            ...
            'domain_admin_portal' => [
                'required' => 'ডোমেইন এডমিন পোর্টাল আবশ্যক',
                'string' => 'ডোমেইন এডমিন পোর্টাল অবশ্যই স্ট্রিং হতে হবে',
            ],
            'company_http_protocol' => [
                'required' => 'কোম্পানি এইচটিটিপি প্রোটোকল আবশ্যক',
                'string' => 'কোম্পানি এইচটিটিপি প্রোটোকল অবশ্যই স্ট্রিং হতে হবে',
            ],
            'support_email' => [
                'required' => 'সাপোর্ট ইমেইল আবশ্যক',
                'string' => 'সাপোর্ট ইমেইল অবশ্যই স্ট্রিং হতে হবে',
            ],
            'support_telephone' => [
                'required' => 'সাপোর্ট টেলিফোন আবশ্যক',

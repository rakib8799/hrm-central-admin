    ...
    */
    ...
    'custom' => [
        ...
        'configuration' => [
            ...
            'domain_admin_portal' => [
                'required' => 'Domain admin portal is required',
                'string' => 'Domain admin portal must be string',
            ],
            'company_http_protocol' => [
                'required' => 'Company http protocol is required',
                'string' => 'Company http protocol must be string',
            ],
            'support_email' => [
                'required' => 'Support email is required',
                'string' => 'Support email must be string',
            ],
            'support_telephone' => [
                'required' => 'Support telephone is required',

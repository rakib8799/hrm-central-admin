                ...
                <VForm @submit="submit()" class="form">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5 g-4">
                            <!-- Max Active Users -->
                            <div class="col-md-6 fv-row">
                                <label class="required fs-5 fw-semibold mb-2">Number of Active Users</label>
                                <Field type="number" class="form-control form-control-lg form-control-solid" placeholder="Number of Active Users" name="max_active_users" v-model="formData.max_active_users"/>
                                <ErrorMessage :errorMessage="formData.errors.max_active_users" />
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
...
const formData = useForm({
    ...
    plan_type: props.subscriptionPlan?.plan_type || '',
    duration: props.subscriptionPlan?.duration || '',
    ...
    max_active_users: props.subscriptionPlan?.max_active_users || ''
});

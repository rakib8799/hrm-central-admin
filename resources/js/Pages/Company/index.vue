                    ...
                    <template v-slot:name="{ row: company }">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <!-- TODO: This following link should be executed when the show method will be implemented -->
...
const props = defineProps({
    company: Object as() => ICompany[] | undefined,
...
onMounted(() => {
    if (props.company) {
        initCompanies.value = props.company.map(company => ({
            id: company.id,
            name: company.name,
            email: company.email,
